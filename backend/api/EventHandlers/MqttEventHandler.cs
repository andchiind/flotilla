...
namespace Api.EventHandlers
{
    ...
    public class MqttEventHandler : EventHandlerBase
    {
            ...
            ref List<string> updatedFields)
        {
            ...
            {
                if (newCurrentAsset.Equals(robot.CurrentArea.Asset.AssetCode, StringComparison.Ordinal))
                {
                    return;
                }

                updatedFields.Add($"\nCurrentAsset ({robot.CurrentArea.Asset.AssetCode} -> {newCurrentAsset})\n");

                robot.CurrentArea.Asset.AssetCode = newCurrentAsset;
            }
